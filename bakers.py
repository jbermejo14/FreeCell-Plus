...
class Card:
    ...
    def clicked(self):
        ...
        for i in front_row_list:
            if i.selected is True and i is not self and i.suit == self.suit and int(i.number) == int(self.number) - 1:
                append = 0
                movement = True
                    ...
                    for lista in card_list:
                        if i in lista:
                            ...
                            def testttt(num, lista, num2):
                                ...
                                for col in card_list:
                                    for card in col:
                                        print(i.coords[0], card.coords[0], i.coords[1], card.coords[1] - num,
                                              i.suit ,card.suit, i.number , card.number)
                                        if i.suit == "Hearts":
                                            if (i.coords[0] == card.coords[0] and i.coords[1] == card.coords[1] - num
                                                    and i.suit == card.suit and int(i.number) - num2 == int(
                                                        card.number)):
                                                lista.remove(card)
                                                append = num2
                                                return card
...
class Column:
    ...
    def clicked(self):
        global num_of_moves
        for i in front_row_list:
            if i.selected is True and self.filled is False:
                for lista in card_list:
                    if i in lista:
                        lista.remove(i)
                        def testttt(num, lista, num2):
                            ...
                            for col in card_list:
                                for card in col:
                                    if i.color == "red":
                                        ...
                                        if (num == 35 or num == 105 or num == 175 or num == 245 or num == 315 or
                                                num == 350 or num == 420):
                                            if (i.coords[0] == card.coords[0] and i.coords[1] == card.coords[1] - num
                                                    and i.color != card.color and int(i.number) - num2 == int(
                                                        card.number)):
...
def front_row():
    ...
    for i in card_list:
        ...
        if len(i) == 1:
            ...
            if len(box_card_list) == 0:
                if i[-1].suit == i[-2].suit and int(i[-1].number) == int(i[-2].number) - 1:
                    front_row_list.append(i[-1])
                    front_row_list.append(i[-2])
                else:
                    front_row_list.append(i[-1])
            elif len(box_card_list) == 1:
                if i[-1].suit == i[-2].suit and int(i[-1].number) == int(i[-2].number) - 1:
                    front_row_list.append(i[-1])
                    front_row_list.append(i[-2])
                else:
                    front_row_list.append(i[-1])
            elif len(box_card_list) == 2:
                if i[-1].suit == i[-2].suit and int(i[-1].number) == int(i[-2].number) - 1:
                    front_row_list.append(i[-1])
                    front_row_list.append(i[-2])
                else:
                    front_row_list.append(i[-1])
            elif len(box_card_list) == 3:
                if i[-1].suit == i[-2].suit and int(i[-1].number) == int(i[-2].number) - 1:
                    front_row_list.append(i[-1])
                    front_row_list.append(i[-2])
                else:
            ...
            if len(box_card_list) == 0:
                if i[-1].suit == i[-2].suit and int(i[-1].number) == int(i[-2].number) - 1:
                    if i[-2].suit == i[-3].suit and int(i[-2].number) == int(i[-3].number) - 1:
                        front_row_list.append(i[-1])
                        front_row_list.append(i[-2])
            ...
            if len(box_card_list) == 0:
                if i[-1].suit == i[-2].suit and int(i[-1].number) == int(i[-2].number) - 1:
                    if i[-2].suit == i[-3].suit and int(i[-2].number) == int(i[-3].number) - 1:
                        if i[-3].suit == i[-4].suit and int(i[-3].number) == int(i[-4].number) - 1:
                            front_row_list.append(i[-1])
                            front_row_list.append(i[-2])
                            front_row_list.append(i[-3])
            ...
            if len(box_card_list) == 0:
                if i[-1].suit == i[-2].suit and int(i[-1].number) == int(i[-2].number) - 1:
                    if i[-2].suit == i[-3].suit and int(i[-2].number) == int(i[-3].number) - 1:
                        if i[-3].suit == i[-4].suit and int(i[-3].number) == int(i[-4].number) - 1:
                            if i[-4].suit == i[-5].suit and int(i[-4].number) == int(i[-5].number) - 1:
                                front_row_list.append(i[-1])
                                front_row_list.append(i[-2])
                                front_row_list.append(i[-3])
                                front_row_list.append(i[-4])
